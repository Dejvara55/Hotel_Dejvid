...
namespace Hotel_Dejvid.Controllers
{
    public class RezervacijasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RezervacijaId,GostId,SobaId,DatumDolaska,DatumOdlaska,Status")] Rezervacija rezervacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RezervacijaId,GostId,SobaId,DatumDolaska,DatumOdlaska,Status")] Rezervacija rezervacija)
        {
